    ...
    var tableIns = table.render({
        ...
        ,cols: [[ //表头
            ...
            ,{field: 'payType', title: '支付方式',sort: true, width:120,templet : function (d) {
                    var payTypeMsg;
                    (d.payType == 1 ? payTypeMsg = "支付宝支付" : (d.payType == 2) ? payTypeMsg = "微信支付" : (d.payType == 3) ? payTypeMsg = "余额支付" : payTypeMsg = "其他方式支付")
                    return payTypeMsg;
                }}
            ...
            ,{field: 'type', title: '类型',sort: true, width:150, templet : function (d) {
					var statusMsg;
            		(d.type == 1 ? statusMsg = "APP充值" : (d.type == 3) ? statusMsg = "后台充值": (d.type == 2) ? statusMsg = "用户提现" : statusMsg = "其他方式充值")
					return statusMsg;
                }}
