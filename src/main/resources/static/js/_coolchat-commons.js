var AppConfig = {
//	apiUrl : "192.168.0.128:8092/",// 接口地址（修改“114.119.6.150”即可）
//    xmppHost:"192.168.0.141",//xmpp 主机的 地址
//    boshDomain : "192.168.0.141",// XMPP主机IP或域名
//	boshUrl : "http://192.168.0.141:5280",// http://+（XMPP主机IP或域名）+（:5280）
...
//	defaultAvatarUrl :"http://119.23.79.36/resources/avatar/t/104/10000104.jpg",// 默认头像地址（）
//    avatarBase : "http://47.91.232.3:8089/avatar/o/",// 头像父目录（修改“file.shiku.co”即可）
    avatarBase : "http://127.0.0.1:8089/avatar/o/",// 头像父目录（修改“file.shiku.co”即可）
